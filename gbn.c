...
B_output(message)  /* Do not implement this routine. It is needed only for bidirectional data transfer */
  struct msg message;
{
...
B_timerinterrupt() /* Do not implement this routine. It is needed only for bidirectional data transfer */
{
